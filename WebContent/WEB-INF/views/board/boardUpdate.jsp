			...
			<table class="board_view">
				...
				<tbody>
					<tr>
						...
						<input type="hidden" id="PASS" name="PASS" value="${map.PASS }">
						</td>
						<th scope="row">조회수</th>
						<td>${map.HIT}</td>
					</tr>
					<tr>
						...
						<td><input type="text" id="NAME" name="NAME"
							class="wdp_90" value="${map.NAME }" /></td>
					...
					<tr>
						<td colspan="4" class="view_text"><textarea rows="20"
								cols="100" title="내용" id="CONTENT" name="CONTENT">${map.CONTENT }</textarea>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<div id="fileDiv">
								<c:forEach var="row" items="${list }" varStatus="var">
									<p>
										<input type="hidden" id="FILE_SEQ" name="FILE_SEQ_${var.index }" value="${row.FILE_SEQ }"> 
