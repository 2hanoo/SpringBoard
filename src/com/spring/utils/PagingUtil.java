...
public class PagingUtil {
	...
	public PagingUtil(String keyField, String keyWord, int currentPage, int totalCount, int rowCount,
		...
		if(currentPage != 1){
			pagingHtml.append("<a href="+pageUrl+"?keyField="+keyField+"&keyWord="+keyWord+"&pageNum="+ 1 + addKey +">");
		...
		//마지막
		if(currentPage != totalPage){
			pagingHtml.append("<a href="+pageUrl+"?keyField="+keyField+"&keyWord="+keyWord+"&pageNum="+ totalPage + addKey +">");
			pagingHtml.append("마지막");
			pagingHtml.append("</a>");
		}
	}
